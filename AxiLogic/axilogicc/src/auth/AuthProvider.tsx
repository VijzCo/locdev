...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [isDevAdmin, setIsVendorAdmin] = useState(false);
  ...
  const value = useMemo<AuthValue>(() => {
    ...
    const lic = isDevAdmin ? vendorLicence() : resolveLicence(licence);
    ...
    phase, user, profile, licence, isDevAdmin, demoMode, usage,
