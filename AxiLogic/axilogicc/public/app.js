...
function wire() {
  ...
  if (!reduced) {
    $("#mkL").style.transform = "translateX(-13px) rotate(-28deg)";
    $("#mkR").style.transform = "translateX(13px) rotate(28deg)";
    setTimeout(() => { $("#mkL").style.transform = "none"; $("#mkR").style.transform = "none"; }, 160);
  }
}
