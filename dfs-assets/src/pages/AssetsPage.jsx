...
const CATEGORIES = ['Laptop','Desktop','Tablet','Router','Access Point','Monitor','Phone','Printer','Server','Switch','UPS','Other']
const STATUSES   = ['Available','Issued','Repair','Retired']

const EMPTY_FORM = { name:'', category:'Laptop', brand:'', model:'', serialNumber:'', department:'', status:'Available', notes:'' }
