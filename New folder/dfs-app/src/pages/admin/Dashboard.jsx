...
export default function Dashboard() {
  ...
  //Seed Sample Data - Uncomment to enable seeding functionality. Remember to comment it back after use to prevent accidental reseeding.
  ...
  try {
    ...
    if (result?.success) {
      ...
      toast.error(result?.error || 'Seed failed. Check console.');
    }
  } catch (error) {
    console.error(error);
